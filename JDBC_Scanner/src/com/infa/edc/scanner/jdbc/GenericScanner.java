...
//				System.out.println(rsTables.getMetaData().getColumnTypeName(5));
				...
				getColumnsForTable(catalogName, schemaName, rsTables.getString("TABLE_NAME"));
			}
...
//			otherObjWriter = new CSVWriter(new FileWriter(otherObjectCsvName), ',', CSVWriter.NO_QUOTE_CHARACTER); 
			...
			tableWriter.writeNext(new String[]{"class","identity","core.name", "core.Decription"});
...
//    	System.out.println("\tcreating database: " + dbName);
   ...
   protected void createColumn(String dbName, String schema, String table, String column, String type, String length, String pos) {
